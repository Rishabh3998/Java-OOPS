...
public class Human {
    ...
    // Hence, it is static in nature, and we have to write static in front of its
    // declaration.
    ...
    public Human (int age, String name, int salary, boolean maritalStatus) {
        ...
        // In order to access the static variable we have to use the class name instead of
        // this keyword.
