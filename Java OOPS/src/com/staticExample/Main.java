...
public class Main {
    public static void main(String[] args) {
        ...
        Human Ritik = new Human(23, "Ritik", 10000, false);
        ...
        // In the above if we try System.out.println(Rishabh.population); it will work, but it is not
        // ideal approach, therefore to access static variable always use dot operator with the class
        // not with the reference variable. This will applicable on everything like declaring, modifying
        // accessing static variable always use class name not reference variable.
